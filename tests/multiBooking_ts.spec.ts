...
const cardTicketText1:any=await matchCards[0].locator("span").filter({hasText:" ticket"}).textContent();
...
const cardTicketText2:any=await matchCards[1].locator("span").filter({hasText:" ticket"}).textContent();
...
const eventTitle1:any=await matchCards[0].locator("div h3").textContent();
const eventTitle2:any=await matchCards[1].locator("div h3").textContent();
